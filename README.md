...
1. This website manage a sale & buying Company
2. Garment Owner upload their garments products
3. Target customer choose their products & bulk order
4. Garment factory making product and sent delivery proper time.
5. Buyer Prebook order
6. G-Flow observed all buyer and seller right.
7. Any valiance buyer & seller account suspend.
8. Three service pack using buyer & seller
...
# Use Npm package :-
    ...
    1. framer-motion : 12.23.25
    2. lottie-react : 2.4.1
    3. sweetalert2 : 11.26.4
    4. swiper: 12.0.3
    5. aos: 2.3.4
